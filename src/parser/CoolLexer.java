// Generated from /mnt/shared/Academic/School/CSE422 - Programming Languages and Compilers/Project/cool-compiler/src/CoolLexer.g4 by ANTLR 4.13.2
package parser;
...
public class CoolLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"FALSE", "INT", "ID", "TYPE", "SELF", "SELF_TYPE", "STRING", "STRING_CONTENT", 
			"ESCAPE_SEQUENCE", "UNTERMINATED_STRING", "SINGLECOMMENT", "MULTICOMMENT", 
			"PLUS", "MINUS", "TIMES", "DIVIDE", "TILDE", "LT", "LEQ", "EQ", "LPAREN", 
			"RPAREN", "LBRACE", "RBRACE", "COLON", "COMMA", "ARROW", "DOT", "SEMICOLON", 
			"AT", "CASEASSIGN", "WS", "A", "B", "C", "D", "E", "F", "G", "H", "I", 
			"L", "N", "O", "P", "R", "S", "T", "U", "V", "W"
		};
	}
